    ...
    return(
      <div className="container-fluid">
        <div className="row">
            ...
            <div className="col-sm-10 col-md-5 work-nav">
                <h3>工作</h3>
                <p>刚毕业，年轻，想出去闯闯，所以去做销售，用两年时间在全国到处跑，深深的感觉到了不太喜欢也不适合做业务，偶然发现了WEB前端开发，一下就喜欢上了它，通过自学，向别人请教，终于使自己成为了别人口中的小菜鸟，然后在北京麦克锐腾科技有限公司工作，主要负责前端页面的开发，维护，配合后台工程师一起研讨前端技术实现方案，提高界面交互体验；</p>
            </div>
            <div className="col-sm-10 col-md-5 work-nav">
                <h3>兴趣</h3>
